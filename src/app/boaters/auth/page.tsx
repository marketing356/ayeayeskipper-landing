...
// RETIRED — this page + /boaters/dashboard were the old (July) boater login/dashboard
// flow, replaced by the real app at app.ayeayeskipper.com (single source of truth).
// Kept as a redirect (not deleted) so old links/bookmarks don't break.
export default function BoaterAuthRetired() {
  useEffect(() => {
